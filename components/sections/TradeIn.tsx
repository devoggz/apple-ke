  ...
  return (
    <section className="bg-gray">
      <div className="px-4 flex flex-col space-y-6 items-center lg:translate-y-20">
        ...
        <button
          onClick={onOpen}
          className="relative z-10 bg-black border-1 border-black text-white py-1.5 px-6 rounded-full text-md cursor-pointer hover:bg-white hover:text-black transition-all duration-300 ease-in-out"
        >
          Check Eligibility
        </button>
