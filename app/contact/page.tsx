    ...
    <div className="min-h-screen  dark:bg-dark-400">
      ...
      <section className="bg-white dark:bg-dark-300 border-b border-gray-200 dark:border-dark-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold text-dark-200  dark:text-dark-100 mb-6">
              Get in Touch
            </h1>
            <p className="text-lg text-dark-100  max-w-3xl mx-auto leading-relaxed">
              As Apple Centre continuously endeavors to give you the best
              devices with the best user experience, we strive to give you the
              best service, repair and customer experience as we make their
              products and services come closer to you. Talk to us for all your
              Apple needs.
            </p>
          </motion.div>
        </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-dark-100 dark:border-dark-200  focus:outline-none focus:ring-1 focus:ring-dark-100 focus:border-transparent transition-all"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={6}
                    className="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-dark-200  focus:outline-none focus:ring-1 focus:ring-dark-100 focus:border-transparent transition-all resize-none"
                ...
                <div className="flex items-center gap-4">
                  <button
                    type="submit"
                    className="flex items-center gap-2 bg-primary hover:bg-primary/90 text-white px-8 py-4 rounded-full font-semibold transition-all "
                  >
                    Send Message
