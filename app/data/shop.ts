    ...
    products: [
      {
        ...
        imagesByColor: {
          Natural: ["/iphone15/natural.png"],
          Black: ["/iphone15/black.png"],
          Blue: ["/iphone15/blue.png"],
          White: ["/iphone15/white.png"],
        },
        heroImage: "/iphone15/hero.png",
        whatsInTheBox: [
          "iPhone 15 Pro",
          "USB-C Cable",
          "SIM Eject Tool",
      ...
      },
      {
        ...
        imagesByColor: {
          Pink: ["/iphone15/pink.png"],
          Yellow: ["/iphone15/yellow.png"],
          Green: ["/iphone15/green.png"],
          Blue: ["/iphone15/blue.png"],
          Black: ["/iphone15/black.png"],
        },
        heroImage: "/iphone15/hero-base.png",
      ...
      },
      {
        ...
        imagesByColor: {
          Midnight: ["/iphone14/midnight.png"],
          Starlight: ["/iphone14/starlight.png"],
          Red: ["/iphone14/red.png"],
        },
        heroImage: "/iphone14/hero.png",
    ...
    products: [
      {
        ...
        screenSizes: ["14-inch"],
        imagesByColor: {
          "Space Black": ["/mbp14/black.png"],
          Silver: ["/mbp14/silver.png"],
        },
        heroImage: "/mbp14/hero.png",
      ...
      },
      {
        ...
        screenSizes: ["15-inch"],
        imagesByColor: {
          Midnight: ["/mba15/midnight.png"],
          Starlight: ["/mba15/starlight.png"],
          Silver: ["/mba15/silver.png"],
        },
        heroImage: "/mba15/hero.png",
      ...
      },
      {
        ...
        screenSizes: ["13-inch"],
        imagesByColor: {
          Silver: ["/mba13/silver.png"],
          "Space Gray": ["/mba13/spacegray.png"],
        },
        heroImage: "/mba13/hero.png",
    ...
    products: [
      {
        ...
        imagesByColor: {
          White: ["/airpodspro/white.png"],
        },
        heroImage: "/airpodspro/hero.png",
        whatsInTheBox: [
          "AirPods Pro",
          "Charging Case",
          "Ear Tips",
      ...
      },
      {
        ...
        imagesByColor: {
          Midnight: ["/watch9/midnight.png"],
          Starlight: ["/watch9/starlight.png"],
          Pink: ["/watch9/pink.png"],
        },
        heroImage: "/watch9/hero.png",
      ...
      },
      {
        ...
        availableStorage: ["Standard"],
        imagesByColor: {
          White: ["/magsafe/white.png"],
        },
        heroImage: "/magsafe/hero.png",
